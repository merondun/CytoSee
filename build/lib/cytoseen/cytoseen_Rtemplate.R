setwd("~/merondun/CytoSeen")
.libPaths('~/mambaforge/envs/test3/lib/R/library')
library(tidyverse)
library(data.table)
library(boot)
library(missMDA)
...
# For rstudio interactive 
params <- list()

# Modify your parameters 
params$info <- "/dss/dsshome1/lxc07/di39dux/merondun/CytoSeen/examples/info.csv"
params$min_cov <- 20
params$max_cov <- 200
params$max_missing <- 0.1
params$outdir <- "/dss/dsshome1/lxc07/di39dux/merondun/CytoSeen/examples/outdir"
params$covdir <- "/dss/dsshome1/lxc07/di39dux/merondun/CytoSeen/examples/biscov"
##### Import data ##### 
t <- fread(params$info)
...
# Perform PCA on the imputed data using FactoMineR
